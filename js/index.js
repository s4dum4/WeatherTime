...
// ESTO ES EL DE SANTIAGO
  ...
  function getCurrentWeather(data) {
    ...
    if (localtime) {
      timeToShow = localtime.split(" ")[1];//SE COLOCA "ESPACIO" PARA QUE LOS SEPARE POR ESPACIO
            //Este split sirve para separar los caracteres como no queremos ver la fecha que es la posicion [0] ps ponemos [1] que es la hora
    } else {
      timeToShow = timeNow;
   ...
   // con el val () le estamos diciendo que nos guarde el valor que le demos al input
